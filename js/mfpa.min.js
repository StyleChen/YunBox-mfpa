...
*/
    ...
    $(".fontSize li:nth-child(1)").click(function () {
        $(".fontSize li").removeClass("activeF")
        $(this).addClass("activeF");
        $(this).css({
            "background":"#F1BE3B"
        })
        $(this).siblings("li").css("background","transparent")
        $("html,body").css("fontSize","20px")
        localStorage.fontSize = $("html").css("fontSize");
    })
    $(".fontSize li:nth-child(2)").click(function () {
        $(this).siblings("li").css("background","transparent")
        $(this).css({
            "background":"#FF5864"
        });
    ...
    $(".fontSize li:nth-child(3)").click(function () {
        $(this).siblings("li").css("background","transparent")
        $(this).css({
            "background":"#27A39C"
        })
    ...
    function localStorageSize() {
        if(!localStorage.fontSize){
            localStorage.fontSize = $("html").css("fontSize");
        }else if(localStorage.fontSize == "20px"){
            $(".fontSize li:nth-child(1)").trigger("click")
        }else if(localStorage.fontSize == "12px"){
            $(".fontSize li:nth-child(3)").trigger("click")
        }else{
            $(".fontSize li:nth-child(2)").trigger("click")
        }
    }
    localStorageSize();

    $(".woocommerce-FormRow.woocommerce-FormRow--wide.form-row.form-row-wide").eq(0).before("<h4 class='text-left'>账号登录</h4>")
