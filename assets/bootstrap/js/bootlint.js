...
(function (exports) {
    ...
    addLinter("E025", function lintPanelFooterWithoutPanel($, reporter) {
        var badPanelFooter = $('.panel-footer.php').parent(':not(.panel, .panel-collapse)');
        if (badPanelFooter.length) {
            reporter("`.panel-footer.php` must have a `.panel` or `.panel-collapse` parent", badPanelFooter);
        }
    });
    ...
    addLinter("E032", function lintModalStructure($, reporter) {
        ...
        elements = $('.modal-footer.php').parent(':not(.modal-content)');
        if (elements.length) {
            reporter("`.modal-footer.php` must be a child of `.modal-content`", elements);
        }
